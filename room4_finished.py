...
room_4_entrance = input("""A large door appears guarded by a gnome. The gnome says; "Welcome to the final room. Before you enter, can you tell me the passcode from Tomato Room?: """)
